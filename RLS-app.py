...
st.write("""
Модель для прогнозирования имеет вид: $$\hat{y_t} = \beta_0 + \beta_1 t + \beta_2 t^2 + ... + \beta_k t^k$$

где $\beta_0, \beta_1, \beta_2, ..., \beta_k$ - коэффициенты модели, которые оцениваются с помощью РМНК.
